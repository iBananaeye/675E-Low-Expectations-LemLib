...
pros::Motor wallStake(WALL_STAKE_PORT,pros::v5::MotorGears::green,pros::v5::MotorEncoderUnits::degrees);
...
deviceInfo devices[13] = {
    ...
    deviceInfo(abs(CONVEYOR_PORT), pros::DeviceType::motor, "Convey"),
    deviceInfo(abs(WALL_STAKE_PORT), pros::DeviceType::motor, "Wall"),
    deviceInfo(abs(COLOR_SENSOR_PORT), pros::DeviceType::optical, "Color"),
    deviceInfo(abs(ROTATION_SENSOR_PORT), pros::DeviceType::rotation, "LBPID"),
    deviceInfo(abs(PERPENDICULAR_TRACKING_ROTATION_PORT), pros::DeviceType::rotation, "Track"),
